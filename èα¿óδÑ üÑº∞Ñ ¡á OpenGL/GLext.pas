...
var
  glFogCoordfEXfloat: procedure(coord: GLfloat); stdcall = nil;
  glFogCoorddEXdouble: procedure(coord: GLdouble); stdcall = nil;
  glFogCoordfvEXfloat: procedure(coord: GLfloat); stdcall = nil;
  glFogCoorddvEXdouble: procedure(coord: GLdouble); stdcall = nil;
...
var
  glSecondaryColor3bEXT: procedure(components: GLbyte); stdcall = nil;
  glSecondaryColor3sEXT: procedure(components: GLshort); stdcall = nil;
  glSecondaryColor3iEXT: procedure(components: GLint); stdcall = nil;
  glSecondaryColor3fEXT: procedure(components: GLfloat); stdcall = nil;
  glSecondaryColor3dEXT: procedure(components: GLdouble); stdcall = nil;
  glSecondaryColor3ubEXT: procedure(components: GLubyte); stdcall = nil;
  glSecondaryColor3usEXT: procedure(components: GLushort); stdcall = nil;
  glSecondaryColor3uiEXT: procedure(components: GLuint); stdcall = nil;
  glSecondaryColor3bvEXT: procedure(components: GLbyte); stdcall = nil;
  glSecondaryColor3svEXT: procedure(components: GLshort); stdcall = nil;
  glSecondaryColor3ivEXT: procedure(components: GLint); stdcall = nil;
  glSecondaryColor3fvEXT: procedure(components: GLfloat); stdcall = nil;
  glSecondaryColor3dvEXT: procedure(components: GLdouble); stdcall = nil;
  glSecondaryColor3ubvEXT: procedure(components: GLubyte); stdcall = nil;
  glSecondaryColor3usvEXT: procedure(components: GLushort); stdcall = nil;
  glSecondaryColor3uivEXT: procedure(components: GLuint); stdcall = nil;
